"""
Code from [`tqdm.contrib.telegram`](https://github.com/tqdm/tqdm/blob/master/tqdm/contrib/telegram.py)
Change by Hyunwoo Ryu and make progressbar output only TelegramIO
"""
